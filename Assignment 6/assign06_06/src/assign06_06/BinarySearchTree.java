...
public class BinarySearchTree {
	...
	private int[] searchChild(int value) {
		...
		while(trav!=null) {
			if(trav.data == value) {
				...
				if(trav.left != null && trav.right!= null)
					...
					return new int[] {trav.left.data,-1};
				else
					return new int[] {-1,trav.right.data};
	...
	public void printChild(int value) {
		int [] arr = searchChild(value);
